...
vav;
#1.Вибрати
усіх клієнтів, чиє ім'я має менше ніж 6 символів.
...
select client.FirstName, d.DepartmentCity from client
    join vav.department d on d.idDepartment = client.Department_idDepartment
