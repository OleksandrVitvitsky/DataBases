...
select *
from cars
where price in (select age from users where gender = 'male');


select count(*) as count, cars.model
from cars
group by model
...
select *
from cars
where price > (select avg(cars.price) from cars);